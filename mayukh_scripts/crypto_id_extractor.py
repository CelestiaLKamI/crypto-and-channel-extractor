...
class MainWindow(QWidget):
    """
    Class MainWindow sets up the functions for the ui
    that lets the user select the choice of layer to extract the ids from
    """
    def __init__(self):
        super().__init__()
    ...
    def update_combobox(self):
        """
        Updates the options based on the available cryptomatte layers from
        ...
        # Add the layer names in the combo box after filtering out the names
        self.comboBox.addItems(self.layer_name_list)

    def extract(self):
        """
        Creates Cryptomatte nodes each containing unique IDs when the user
        hits the extract button after selecting their choice of cryptomatte layer
        """
        ...
        # Closes the function after successful extraction of ids
        window.close()
